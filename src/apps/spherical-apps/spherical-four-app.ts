...
import { App, Camera, Parameter, EnumParameter, Graph, ShaderMesh, UI, Mesh, Vector3, DrawSpeed, Matrix4, InputState, Scene, SkyBoxShader } from "Geon";
import { quadification, averageEdgeLength, squarification, laPlacian } from "./spherical";

export class SphericalFourApp extends App {
    ...
    constructor(gl: WebGLRenderingContext) {
        ...
        let camera = new Camera(canvas, 1, true);
        camera.set(-4.48, 1.24, -0.71);
