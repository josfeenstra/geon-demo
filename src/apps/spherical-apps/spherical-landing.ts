...
// import { App, Parameter, EnumParameter, Graph, Vector3, Vector2, Camera, UI, InputState, GeonMath, Matrix4, Const, Scene, MeshBufferer, InputHandler, Pointertype } from "Geon";
...
//         if (input.pointerType == Pointertype.Touch) {
//             return;
//         }

//         // update rotation
//         let speedb = 0.00007 * input.time.tick;
//         let scalar = 1 + 4 * Math.log10(1 + this.mousePos.disTo(input.mouse?.pos);
